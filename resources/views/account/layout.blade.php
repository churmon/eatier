...
<head>
  ...
  <title>Eater</title>
  <!-- plugins:css -->
  <link rel="stylesheet" href="account/vendors/mdi/css/materialdesignicons.min.css">
  <link rel="stylesheet" href="account/vendors/base/vendor.bundle.base.css">
  <!-- endinject -->
  <!-- plugin css for this page -->
  <link rel="stylesheet" href="account/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
...
<body>
  ...
  <!-- plugins:js -->
  <script src="account/vendors/base/vendor.bundle.base.js"></script>
  <!-- endinject -->
  <!-- Plugin js for this page-->
  <script src="account/vendors/chart.js/Chart.min.js"></script>
  <script src="account/vendors/datatables.net/jquery.dataTables.js"></script>
  <script src="account/vendors/datatables.net-bs4/dataTables.bootstrap4.js"></script>
  ...
  <script src="account/js/jquery.dataTables.js"></script>
  <script src="account/js/dataTables.bootstrap4.js"></script>
