...
@section('content')
  ...
  {{-- ads  --}}
    ...
    <div class=" flex flex-col md:flex py-10 max-w-6xl mx-auto ">
    ...
    <div class="flex w-full h-screen">
        ...
        <div class=" h-full w-24 md:w-[200px] ">
          ...
          <div class="flex flex-col gap-2 mt-1">
            <div>
              <img src="https://images.unsplash.com/photo-1615282720169-46f05893ce8c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8bWFjZG9uYWxkfGVufDB8fDB8fHww" alt="" class="w-full md:h-32 object-cover">
            </div>
      
            <div>
              <img src="https://images.unsplash.com/photo-1615282720169-46f05893ce8c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8bWFjZG9uYWxkfGVufDB8fDB8fHww" alt="" class="w-full md:h-36 object-cover">
            </div>
          </div>

        </div>

        <div class="h-full w-full grid md:grid-cols-3 mx-1 gap-4 overflow-y-auto">
