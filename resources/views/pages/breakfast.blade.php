...
@section('content')
  ...
  <div class= "mx-2 mt-3 w-full">
    <div class="max-w-6xl mx-auto text-xl font-bold">Breakfast</div>
  {{-- ads  --}}
    ...
    <div class="flex flex-col md:flex sm py-10 max-w-6xl mx-auto ">
        <div class="font-bold mr-1">Breakfast</div>
    ...
    <div class="flex w-full h-screen">
        {{-- ads --}}
        <div class=" h-full w-24 md:w-[200px]">
          <div class="border-2 rounded-t-lg border-gray-600">
            ...
            <div class="mb-3">
                <button id="dropdownHoverButton2" data-dropdown-toggle="dropdownHover2" data-dropdown-trigger="hover" class="text-black  focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-sm px-5 py-2.5 text-left md:text-center inline-flex md:items-center font-bold w-full " type="button">Add-ons <svg class="w-2.5 h-2.5 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                    </svg>
                </button>
          ...
          <div class="flex flex-col gap-2 mt-1">
            <div>
              <img src="https://images.unsplash.com/photo-1615282720169-46f05893ce8c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8bWFjZG9uYWxkfGVufDB8fDB8fHww" alt="" class="w-full h-full md:w-full md:h-32 object-cover">
            </div>
        ...
        <div class="h-full w-full md:w-full grid md:grid-cols-3 mx-1 gap-4 overflow-y-auto">
