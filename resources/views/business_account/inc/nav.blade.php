<div class="flex justify-between items-center mt-10 mx-2">
    <a href="{{route('business')}}" class="font-bold text-red-700">Posts</a>
    
    <a href="{{route('business.info')}}">
        <?xml version="1.0" encoding="utf-8"?>
        <svg fill="#c81e1e" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8">
    ...
    <a href="{{route('business.videos')}}">
        <?xml version="1.0" encoding="utf-8"?>
        <svg class="w-8 h-8" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" aria-labelledby="videoIconTitle" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none" color="#000000"> <title id="videoIconTitle">Video</title> <polygon points="18 12 9 16.9 9 7"/> <circle cx="12" cy="12" r="10"/> </svg>
    </a>

    <a href="{{route('menus.starters')}}">
        <svg class="w-8 h-8" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"     xmlns:xlink="http://www.w3.org/1999/xlink" 
      ...
      {{-- image   --}}
   <a href="{{route('business.images')}}">
        <?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
        <svg class="w-8 h-8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000000" stroke-width="1" stroke-linecap="round" stroke-linejoin="miter"><polygon points="22 15.5 17 10 10.59 16.99 6.5 13 2 17.5 2 22 22 22 22 15.5"></polygon><rect x="2" y="2" width="20" height="20" rx="0"></rect><line x1="6.99" y1="7" x2="7" y2="7" stroke-linecap="round" stroke-width="2"></line>
        </svg>
   </a>

    <a href="{{route('business.review')}}">
        <svg class="w-8 h-8" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 508 508" xml:space="preserve" fill="#ffffff" stroke="#ffffff">
    ...
    <a href="{{route('business.green')}}">
        <?xml version="1.0" encoding="UTF-8"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
            <svg fill="#000000" class="w-8 h-8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"><path d="M3,13A9,9 0 0,0 12,22A9,9 0 0,0 3,13M12,22A9,9 0 0,0 21,13A9,9 0 0,0 12,22M18,3V8A6,6 0 0,1 12,14A6,6 0 0,1 6,8V3C6.74,3 7.47,3.12 8.16,3.39C8.71,3.62 9.2,3.96 9.61,4.39L12,2L14.39,4.39C14.8,3.96 15.29,3.62 15.84,3.39C16.53,3.12 17.26,3 18,3Z" /></svg>
    </a>
